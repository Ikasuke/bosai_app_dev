...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "bosai_app_dev_#{Rails.env}"
  ...
  config.action_mailer.defautlt_url_options = {
    host: Rails.application.credentials.dig(:production, :HOST_ADDRESS),
  }
